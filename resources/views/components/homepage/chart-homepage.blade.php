             ...
             <div class="card">
                 <div class="card-body">
                     <div class="row pb-50">
                         ...
                         <div
                             class="col-lg-6 col-12 d-flex justify-content-between flex-column text-end order-lg-2 order-1">
                             <div class="dropdown chart-dropdown">
                         ...
                         <div class="card-header d-flex justify-content-between align-items-end">
                             ...
                             <div class="dropdown chart-dropdown">
                                 <button class="btn btn-sm border-0 dropdown-toggle px-50" type="button"
                                     id="dropdownItem1" data-bs-toggle="dropdown" aria-haspopup="true"
                                     aria-expanded="false">
                                     Last 7 Days
                                 </button>
                 ...
                 <div class="col-md-6 col-12">
                     <div class="card">
                         <div class="card-header d-flex justify-content-between align-items-end">
                             ...
                             <div class="dropdown chart-dropdown">
                                 <button class="btn btn-sm border-0 dropdown-toggle px-50" type="button"
                                     id="dropdownItem3" data-bs-toggle="dropdown" aria-haspopup="true"
                                     aria-expanded="false">
                                     Last 7 Days
                                 </button>
